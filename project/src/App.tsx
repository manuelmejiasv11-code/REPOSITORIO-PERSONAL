...
const sheets: Sheet[] = [
  ...
  access('6', 'Acceso · Falcón', 'RED DE DISTRIBUCIÓN - NODO CHICHIRIVICHE (OLT 1)', "NODO CHICHIRIVICHE / OLT 1 | Av. Cuare con Calle Zamora, Chichiriviche, Falcón | 10°55'44.4\"N 68°16'30.0\"O", [
