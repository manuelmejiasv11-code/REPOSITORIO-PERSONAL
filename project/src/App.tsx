...
const kindMeta: Record<NodeKind, { label: string; icon: typeof Globe2; tone: string }> = {
  isp: { label: 'ISP / Proveedor', icon: Globe2, tone: 'isp' },
  core: { label: 'OLT / Nodo', icon: Server, tone: 'core' },
  fdt: { label: 'FDT', icon: Router, tone: 'fdt' },
  nap: { label: 'NAP', icon: Cable, tone: 'nap' },
  onu: { label: 'ONU cliente', icon: Wifi, tone: 'onu' },
};
